!(function (TynApp) {
      ...
      reply: {
        ...
        scroll: function(){
          ...
          if(chatBody){
            ...
            if (simpleChatBody.getScrollElement()) {
        ...
        if(elm){
          elm.forEach(item => {
            item.addEventListener('click', (e)=>{
              ...
              if (document.getElementById('tynMain')) {
                document.getElementById('tynMain').classList.remove('aside-shown');
    ...
    TynApp.ImageViewer = function(){
      $(".viewable-image").click(function(){
